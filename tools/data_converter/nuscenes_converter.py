...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        if not test:
            ...
            ###############################
            # print('#############################')
            # print( nusc.box_velocity( sample['anns'][0] ) )
            velocity = np.array(
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                # print(f' height is {height} the expected size is 900 ')
                # print(f' width is {width} the expected size is 1600 ')
                # assert height == 900 and width == 1600 ,'height or width error'
