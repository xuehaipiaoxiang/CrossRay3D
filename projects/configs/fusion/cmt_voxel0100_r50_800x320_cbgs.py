...
train_pipeline = [
    ...
    dict(type='ModalMask3D', mode='train'), # to mask
    dict(
...
momentum_config = dict(
    ...
    step_ratio_up=0.4)
total_epochs = 55
# checkpoint_config = dict(interval=1) to save disk space
...
# resume_from = './work_dirs/cmt_voxel0100_r50_800x320_cbgs/epoch_40.pth'
resume_from = None
