...
int points_of_pillar_in_gt_gpu(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor box_idx_of_points_tensor){
    // params boxes: (B, N, 7) [x, y, z, dx, dy, dz, heading] (x, y, z) is the box center
    // params pts: (B, npoints, 3) [x, y, z]
    // params boxes_idx_of_points: (B, npoints), default -1
...
//    CHECK_INPUT(box_idx_of_points_tensor);
    ...
    points_in_pillars_launcher(batch_size, boxes_num, pts_num, boxes, pts, box_idx_of_points);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("points_of_pillar_in_gt_gpu", &points_of_pillar_in_gt_gpu, "points_of_pillar_in_gt_gpu forward (CUDA)");
