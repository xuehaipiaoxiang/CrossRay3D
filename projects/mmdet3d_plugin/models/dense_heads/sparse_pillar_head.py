...
################### DN
    ...
    def forward_single(self, pts_dict, img_dict, img_metas):
        ...
        if not isinstance(img_metas, list):
            img_metas = [img_metas]
        pts_feats, pts_3d_pe, _, _ = self.generate_mape(pts_dict, img_dict, img_metas)

        reference_points = self.reference_points.weight
        # self._visualize(reference_points, choice='bev') # slot for vis
        ...
        pts_query_embeds, _ = self.query_embed(reference_points, img_metas)
        query_embeds = pts_query_embeds
