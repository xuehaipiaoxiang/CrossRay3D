...
# from .focal_sparse_utils import split_voxels, check_repeat, FocalLoss
# from ..ops.roi_aware_pool3d.roiaware_pool3d_utils import points_in_boxes_gpu
...
#     #             voxels_3d_batch = rotate_points_along_z(voxels_3d_batch[:, self.inv_idx].unsqueeze(0), -batch_dict['noise_rot'][b].unsqueeze(0))[0, :, self.inv_idx]
...
#                 gt_boxes = batch_dict['gt_boxes'][b][ :, :-2].unsqueeze(0)
#                 gt_boxes = gt_boxes.to(voxels_3d_batch.device)
